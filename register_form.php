		...
		<form id="signup_form" onsubmit="return false" class="login100-form">
		    <div class="billing-details jumbotron">
                ...
                <div class="form-group ">                    
                    <input class="input form-control input-borders" type="text" name="f_name" id="f_name" placeholder="Primer nombre">
                </div>
                <div class="form-group">                    
                ...
                <div class="text-pad">
                    <a href="#" id="openLoginModal" data-toggle="modal" data-target="#Modal_login">¿Ya tienes una cuenta? Inicia sesión</a>                        
                </div>
        </form>
